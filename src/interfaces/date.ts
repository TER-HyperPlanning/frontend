...
{type:| "addEditable" | "removeDays", value: Date[]}
|{type:| "resetEditableOnly"}
|{type:"setDatesForDayPicker", value:Date}
|{type:"addYearToEditable" |"resetYear",  value:number}
|{type:"addMonthToEditable" | "resetMonth", value:{month:number, year:number}}
